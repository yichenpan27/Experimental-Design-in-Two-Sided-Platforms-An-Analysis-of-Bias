...
if __name__ == '__main__':
    ...
    sim_bias = pd.DataFrame({
        0.15: est_stats['abs_bias_over_GTE']
    })
    sim_bias.index = est_stats.index
    sim_se = pd.DataFrame({
        0.15: est_stats['std_over_GTE']
    })
    sim_se.index = est_stats.index
    sim_rmse = pd.DataFrame({
        0.15: est_stats['rmse_over_GTE']
    })
    ...
    sim_bias[0.32] = est_stats['abs_bias_over_GTE']
    sim_se[0.32] = est_stats['std_over_GTE']
    sim_rmse[0.32] = est_stats['rmse_over_GTE']
    ...
    sim_bias[0.62] = est_stats['abs_bias_over_GTE']
    sim_se[0.62] = est_stats['std_over_GTE']
    sim_rmse[0.62] = est_stats['rmse_over_GTE']
