...
customer_type_base = {'c1':1}
listing_type_base = {'l1':0.315,'l2':0.315}
...
if __name__ == '__main__':
    ...
    sim_bias = pd.DataFrame({
        'Hom.': est_stats['abs_bias_over_GTE']
    })
    sim_bias.index = est_stats.index
    sim_se = pd.DataFrame({
        'Hom.': est_stats['std_over_GTE']
    })
    sim_se.index = est_stats.index
    sim_rmse = pd.DataFrame({
        'Hom.': est_stats['rmse_over_GTE']
    })
    sim_rmse.index = est_stats.index

    listing_type_base = {'l1':0.25, 'l2':0.4}
    vs = {}
    for c in customer_types:
        vs[c] = {}
        vs[c]['treat'] = {}
    ...
    sim_bias['Het-L'] = est_stats['abs_bias_over_GTE']
    sim_se['Het-L'] = est_stats['std_over_GTE']
    sim_rmse['Het-L'] = est_stats['rmse_over_GTE']

    listing_type_base = {'l1':0.1,'l2':0.6}
    vs = {}
    for c in customer_types:
        vs[c] = {}
        vs[c]['treat'] = {}
    ...
    sim_bias['Het-H'] = est_stats['abs_bias_over_GTE']
    sim_se['Het-H'] = est_stats['std_over_GTE']
    sim_rmse['Het-H'] = est_stats['rmse_over_GTE']
    ...
    plt.xlabel("Heterogeneity of Listings")
